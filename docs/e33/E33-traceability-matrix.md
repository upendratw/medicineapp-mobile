...
| MED-1356      | deployment discovery/config review                     | Expo/release/export validation                    | development deployment report; actual deployment pending  |
| MED-1357      | no runtime deployment                                  | full automated suite                              | development smoke report; deployed smoke pending          |
