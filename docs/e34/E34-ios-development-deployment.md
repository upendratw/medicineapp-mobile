...
For bounded local physical-iPhone testing with a free Personal Team, use the canonical switch and clean-prebuild/Xcode workflow in `E34-personal-team-local-iphone-build.md`. Push is explicitly unavailable in that build; EAS profiles do not set the switch and retain APNs readiness.
